  ...
  return (
    <>
      ...
      <div className="sm:max-w-5xl mx-auto flex flex-col justify-center items-center px-2 mt-5">
        ...
        <p>Welcome to GearOnlineColts!</p>

        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          These terms and conditions outline the rules and regulations for the
          use of GearOnlineColts's Website, located at www.gearonlinecolts.com.
        </p>

        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use GearOnlineColts if you do not agree
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          We employ the use of cookies. By accessing GearOnlineColts, you agreed
          to use cookies in agreement with the GearOnlineColts's Privacy Policy.
        </p>
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          Unless otherwise stated, GearOnlineColts and/or its licensors own the
          intellectual property rights for all material on GearOnlineColts. All
          intellectual property rights are reserved. You may access this from
          GearOnlineColts for your own personal use subjected to restrictions
        ...
        <ul className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          <li>Republish material from GearOnlineColts</li>
          <li>Sell, rent or sub-license material from GearOnlineColts</li>
          <li>Reproduce, duplicate or copy material from GearOnlineColts</li>
          <li>Redistribute content from GearOnlineColts</li>
        </ul>
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          ...
          GearOnlineColts does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of GearOnlineColts,its agents and/or affiliates.
          ...
          GearOnlineColts shall not be liable for the Comments or for any
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          GearOnlineColts reserves the right to monitor all Comments and to
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          You hereby grant GearOnlineColts a non-exclusive license to use,
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          ...
          the hyperlink compensates the absence of GearOnlineColts; and (d) the
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          ...
          sending an e-mail to GearOnlineColts. Please include your name, your
        ...
        <p className="text-base font-light leading-relaxed mt-3 mb-4 text-gray-700 md:max-w-3xl">
          No use of GearOnlineColts's logo or other artwork will be allowed for
